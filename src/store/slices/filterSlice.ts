...
const filterSlice = createSlice({
  ...
  reducers: {
    ...
    setRecentOrdersCount: (state, action: PayloadAction<FilterState['recentOrdersCount']>) => {
      state.recentOrdersCount = action.payload;
    },
    setOpenOrdersCount: (state, action: PayloadAction<FilterState['openOrdersCount']>) => {
      state.openOrdersCount = action.payload;
    },
...
export const selectFilters = createSelector(
  ...
  (filterState) => ({
    ...
    recentOrdersCount: filterState.recentOrdersCount || undefined,
    openOrdersCount: filterState.openOrdersCount || undefined,
  })
);
